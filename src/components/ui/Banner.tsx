  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        {/* Left Background */}
        <div 
          className="absolute left-0 top-0 w-[348px] h-[801px] opacity-40 transform -translate-y-4"
          style={{
        ...
        {/* Right Background */}
        <div 
          className="absolute right-0 top-0 w-[514px] h-[797px] opacity-40 transform rotate-[-16.17deg] translate-x-48 -translate-y-24"
          style={{
            backgroundImage: `url(${backgroundImage1})`,
            backgroundSize: '358.1% 104.32%',
            backgroundPosition: '99.97% 100%',
            backgroundRepeat: 'no-repeat'
          }}
          aria-hidden="true"
        />
        ...
        {/* Vector Background */}
        <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[994px] h-[675px] opacity-20">
          <Image
            src={vectorBg}
            alt=""
            fill
        ...
        <div 
          className="absolute bottom-0 left-0 right-0 h-[296px] opacity-60"
          style={{
        ...
        <div className="hidden lg:block absolute top-1/2 right-4 w-[351px] h-[351px] transform -translate-y-1/2 opacity-20">
          <Image
            src={circleDecor1}
            alt=""
            fill
      ...
      {/* Content */}
      <div className="container-site relative z-10 flex flex-col items-center justify-center min-h-screen py-20">
        {/* Main Content */}
        <div className="text-center max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
            ...
            <button 
              className="border border-white text-white font-['Wix_Madefor_Display',_sans-serif] font-semibold text-base px-[18px] py-3.5 rounded-[41px] hover:bg-white hover:text-[#000648] transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#000648] min-w-[160px]"
            ...
            <a 
              href="/contact-us"
              className="bg-[#3eff51] text-black font-['Wix_Madefor_Display',_sans-serif] font-semibold text-base px-[18px] py-3.5 rounded-[41px] hover:bg-[#35e047] transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#3eff51] focus:ring-offset-2 focus:ring-offset-[#000648] min-w-[140px] inline-block text-center"
